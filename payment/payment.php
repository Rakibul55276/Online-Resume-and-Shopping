...
<body>
    ...
    <div class="modal__container">
      <div class="modal__featured">
		...
		<img src="../project/images/resume-2.jpg" class="modal_product" />
      </div>
...
<div class="table-responsive">  
        ...
        <tr>  
             ...
             <th align="right" width="10%">Total(RM)</th>  
		</tr>  
         <?php $total=0; ?>
         <?php $shop = $mysqli->query("SELECT * FROM carttable WHERE username = '$user_name'");?>
         <?php while ($srow= mysqli_fetch_array($shop)) {   ?>
			<?php $x=1;?>
			<tr>  
                 <td> <?php echo  $srow["nameitem"];?> </td>
				 <td align="center"> <?php echo  $srow["quantity"];?> </td>
				 <td align="right"> <?php echo  number_format($srow["priceitem"],2);?> </td>
				 <td align="right"> <?php echo number_format($srow['priceitem']* $srow['quantity'], 2); ?></td>  
				<?php   $total = $total + ($srow['priceitem']* $srow['quantity']);  ?>
           </tr>  
			<?php } ?>
			<tr>  
			 <td></td>
             ...
             <td align="right" ><?php echo "RM ".number_format($total, 2); ?></td> 
        ...
        <form>
          <ul class="form-list">
            ...
            <li>
              <button type="submit" class="button" onclick="paymentconfirm()">Pay Now</button>
            </li>
          </ul>
        </form>
