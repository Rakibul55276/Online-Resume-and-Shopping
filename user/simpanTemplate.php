<?php
   ...
   foreach($_POST as $bill=>$record){
   	...
   	if(isset($record['orders'])){
   		$idtemplate_order= $_SESSION['idtemplate'];
           ...
           $sql = "INSERT INTO template_order VALUES (null, '$template_name','$type','$price')";
   		//echo $sql.'<br>';
...
<?php
   function unik($idtemplate_order,$iduser){
   	...
   	else $sql = "SELECT *FROM template_order WHERE iduser = '$iduser' AND idtemplate_order != $idtemplate_order";
